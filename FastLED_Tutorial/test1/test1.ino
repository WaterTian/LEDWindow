...
void loop() {
  ...
  if(a0<100)
  {
    fill_solid(leds[0], NUM_LEDS, CRGB::HotPink);
  }else{
  ...
  if(a1<100)
  {
    fill_solid(leds[1], NUM_LEDS, CRGB::HotPink);
  }else{
    fill_solid(leds[1], NUM_LEDS, CRGB(0, 0, 0));
  }
  FastLED.show();

  if(a2<100)
  {
    fill_solid(leds[2], 300, CRGB::HotPink);
  }else{
    fill_solid(leds[2], 300, CRGB(0, 0, 0));
  }
  FastLED.show();
